        ...
        children: [
              ...
              children: [
                ...
                if(status == "Playing" || status == "Paused" || status == "Assigned")...[
                  Row(
                    children: [
                      IconButton(
                        icon: Icon(isPlaying ? Icons.pause_circle : Icons.play_circle, color: Colors.blue, size: 25,),
                        onPressed: () async {
                      ...
                      IconButton(
                        icon: Icon(Icons.check_circle, color: Colors.blue, size: 25,),
                        onPressed: () async{
                          final uid = FirebaseAuth.instance.currentUser!.uid;
                          final taskRef = FirebaseDatabase.instance.ref("users/$uid/tasks");
                          final snapshot = await taskRef.get();
          ...
          Positioned(
            ...
            child: IconButton(
              ...
              onPressed: () async{
                final uid = FirebaseAuth.instance.currentUser!.uid;
                final taskRef = FirebaseDatabase.instance.ref("users/$uid/tasks/$taskId");
